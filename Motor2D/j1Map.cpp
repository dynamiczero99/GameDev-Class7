...
void j1Map::Draw()
{
	...
	for (p2List_item<MapLayer*>* layer = data.layers.start; layer != data.layers.end; layer = layer->next)
	{
...
TileSet* j1Map::GetTilesetFromTileId(int id) const
{
	...
	for (p2List_item<TileSet*>* iterator = data.tilesets.start; iterator != data.tilesets.end->next ; iterator = iterator->next)
	{
		if (iterator->data->firstgid >= id)
